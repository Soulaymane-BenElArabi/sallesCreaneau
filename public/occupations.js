      ...
      .map((occupation) => {
        ...
        return `
          <tr>
              ...
              <td>
              <button type="button" class="btn btn-success"data-id="${occupationID}" data-salleid="${salle._id}" data-creneauid="${creneau._id}">
              <i>Modifier</i>
              </button>
              </td>
              <td>
              <button type="button" class="btn btn-danger" data-id="${occupationID}">
              <i>Supprimer</i>
              </button>
              </td>
            </tr>
